...
#include "K2Node_RequestPoolableObject.h"
...
#define LOCTEXT_NAMESPACE "K2Node_RequestPoolableObjectHelper"

UK2Node_RequestPoolableObject::UK2Node_RequestPoolableObject(const FObjectInitializer& ObjectInitializer)
: Super(ObjectInitializer)
{
	
}

void UK2Node_RequestPoolableObject::AllocateDefaultPins()
{
	Super::AllocateDefaultPins();
}

void UK2Node_RequestPoolableObject::ExpandNode(FKismetCompilerContext& CompilerContext, UEdGraph* SourceGraph)
{
...
void UK2Node_RequestPoolableObject::PinDefaultValueChanged(UEdGraphPin* Pin)
{
...
FText UK2Node_RequestPoolableObject::GetKeywords() const
{
	return LOCTEXT("RequestPoolableObject", "Request");
}

bool UK2Node_RequestPoolableObject::HasExternalDependencies(TArray<UStruct*>* OptionalOutput) const
{
...
void UK2Node_RequestPoolableObject::PostPlacedNewNode()
{
...
void UK2Node_RequestPoolableObject::AddSearchMetaDataInfo(TArray<FSearchTagDataPair>& OutTaggedMetaData) const
{
...
void UK2Node_RequestPoolableObject::PostReconstructNode()
{
	Super::PostReconstructNode();
	RefreshOutputPinType();
}

FString UK2Node_RequestPoolableObject::GetPinMetaData(FName InPinName, FName InKey)
{
...
void UK2Node_RequestPoolableObject::NotifyPinConnectionListChanged(UEdGraphPin* Pin)
{
...
void UK2Node_RequestPoolableObject::ReallocatePinsDuringReconstruction(TArray<UEdGraphPin*>& OldPins)
{
	AllocateDefaultPins();
...
void UK2Node_RequestPoolableObject::GetNodeAttributes(TArray<TKeyValuePair<FString, FString>>& OutNodeAttributes) const
{
	UClass* ClassToSpawn = GetClassToSpawn();
...
void UK2Node_RequestPoolableObject::GetMenuActions(FBlueprintActionDatabaseRegistrar& ActionRegistrar) const
{
	struct GetMenuActions_Utils
	{
		static void SetNodeFunc(UEdGraphNode* NewNode, bool /*bIsTemplateNode*/, TWeakObjectPtr<UFunction> FunctionPtr)
		{
			UK2Node_RequestPoolableObject* AsyncTaskNode = CastChecked<UK2Node_RequestPoolableObject>(NewNode);
	...
	ActionRegistrar.RegisterClassFactoryActions<UAsyncAction_RequestPoolableObject>(FBlueprintActionDatabaseRegistrar::FMakeFuncSpawnerDelegate::CreateLambda([NodeClass](const UFunction* FactoryFunc)->UBlueprintNodeSpawner*
	{
...
FText UK2Node_RequestPoolableObject::GetMenuCategory() const
{
...
void UK2Node_RequestPoolableObject::CreatePinsForClass(UClass* InClass, TArray<UEdGraphPin*>* OutClassPins)
{
	check(InClass);
...
UEdGraphPin* UK2Node_RequestPoolableObject::GetClassPin(const TArray<UEdGraphPin*>* InPinsToSearch /*= NULL*/) const
{
...
UEdGraphPin* UK2Node_RequestPoolableObject::GetWorldContextPin() const
{
...
UEdGraphPin* UK2Node_RequestPoolableObject::GetResultPin() const
{
...
UEdGraphPin* UK2Node_RequestPoolableObject::GetRequestResultPin() const
{
...
UEdGraphPin* UK2Node_RequestPoolableObject::GetRequestSuccessPin() const
{
...
void UK2Node_RequestPoolableObject::OnClassPinChanged()
{
...
bool UK2Node_RequestPoolableObject::ConnectSpawnProperties(UClass* ClassToSpawn, const UEdGraphSchema_K2* Schema, class FKismetCompilerContext& CompilerContext, UEdGraph* SourceGraph, UEdGraphPin*& LastThenPin, UEdGraphPin* SpawnedActorReturnPin)
{
